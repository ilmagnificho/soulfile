...
function ReportContent() {
    ...
    return (
        <main className="min-h-screen bg-black text-white p-4 md:p-8 relative overflow-hidden pb-32">
            ...
            {/* 🔥 PAYMENT BUTTON MOVED HERE - OUTSIDE MOTION.DIV 🔥 */}
            <div className="fixed bottom-0 left-0 w-full z-[9999] p-4 bg-gradient-to-t from-black via-black/95 to-transparent">
